# Generated by Django 4.1.5 on 2023-03-14 13:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.CharField(help_text='Введите дату рождения', max_length=100, null=True, verbose_name='Дата рождения')),
                ('date_of_death', models.CharField(help_text='Введите дату смерти', max_length=100, null=True, verbose_name='Дата смерти')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите статус экземпляра книги', max_length=20, verbose_name='Статус экземпляря книги')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('imprint', models.CharField(help_text='Введите издательсво и год выпуска', max_length=200, verbose_name='Издательство')),
