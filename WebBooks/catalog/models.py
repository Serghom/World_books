...
class Author(models.Model):
    ...
    date_of_birth = models.DateField(max_length=100, help_text="Введите дату рождения", verbose_name="Дата рождения", null=True, blank=True)
    date_of_death = models.DateField(max_length=100, help_text="Введите дату смерти", verbose_name="Дата смерти", null=True, blank=True)
...
class Status(models.Model):
    name = models.CharField(max_length=20, help_text="Введите статус экземпляра книги", verbose_name="Статус экземпляря книги")
...
class BookInstance(models.Model):
    ...
    imprint = models.CharField(max_length=200, help_text="Введите издательсво и год выпуска", verbose_name="Издательство")
